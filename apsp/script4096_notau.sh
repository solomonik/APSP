...
#PBS -j eo
#PBS -o dcapsp.hopper.1024nodes.g.out
#PBS -e dcapsp.hopper.1024nodes.g.out
...
aprun -n 4096 -N 4 -d 6 -ss ./test_dcapsp -pdim 16 -n 32768 -b1 32 -b2 32 -test 0 -crep 16


aprun -n 4096 -N 4 -d 6 -ss ./test_dcapsp -pdim 64 -n 65536 -b1 32 -b2 32 -test 0 -crep 1
aprun -n 4096 -N 4 -d 6 -ss ./test_dcapsp -pdim 32 -n 65536 -b1 32 -b2 32 -test 0 -crep 4
aprun -n 4096 -N 4 -d 6 -ss ./test_dcapsp -pdim 64 -n 131072 -b1 64 -b2 64 -test 0 -crep 1
